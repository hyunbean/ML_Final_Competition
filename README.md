...
> 4인 팀 참가, **Public 1위 → Private 2위**. 순위가 뒤집힌 원인(public-overfit)까지 정량 분석한 회고가 이 repo의 핵심 자산입니다.

## 📊 결과

| | Public | Private | 최종 순위 |
|---|---|---|---|
| **우리 팀** | **0.7385 (1위)** | 0.7324 | **2위** |
...
팀 분담: 신현빈(파이프라인·pseudo·블렌드·제출 전략) / 김민형(base 메타스택 재구축·RunPod 학습) / 조아인·이두영. AI 페어프로그래밍을 실험 운영에 적극 활용했으며, 그 과정에서 얻은 **AI 협업 운영 노하우**(체크리스트 관리, 할루시네이션 방지, 교차검증)도 회고 섹션 9·13에 문서화했습니다.
